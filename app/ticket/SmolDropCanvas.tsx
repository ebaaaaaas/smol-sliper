...
const CONFIG = {
  ...
  auto: {
    ...
    pausePortion: 0.0, // микро пауза перед ударом
  },
  ...
  shock: {
    ...
    width: 120, // было 52 (шире -> одна мягкая волна, без двойной линии)
